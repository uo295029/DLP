...
public class GrammarParser extends Parser {
	...
	public static final int
		...
		T__38=39, ID=40, INT_LITERAL=41, FLOAT_LITERAL=42, CHAR_LITERAL=43, BOOL_LITERAL=44, 
	...
	private static String[] makeSymbolicNames() {
		return new String[] {
			...
			"BOOL_LITERAL", "LINE_COMMENT", "MULTILINE_COMMENT", "WHITESPACE"
		};
	}
	...
	public final FunctionDefinitionContext functionDefinition() throws RecognitionException {
		...
		try {
			...
			_errHandler.sync(this);
			_la = _input.LA(1);
			while (((_la) & ~0x3f) == 0 && ((1L << _la) & 16492692077584L) != 0) {
				{
				{
				setState(67);
	...
	public final StatementContext statement() throws RecognitionException {
		...
		try {
			...
			case 1:
				...
				_errHandler.sync(this);
				_la = _input.LA(1);
				if (((_la) & ~0x3f) == 0 && ((1L << _la) & 16492691718160L) != 0) {
					{
					setState(93);
	...
	public final TypeContext type() throws RecognitionException {
		...
		try {
			...
			case T__38:
				...
				setState(296);
				match(T__38);
				 ((TypeContext)_localctx).ast =  new BoolType(); 
				}
				break;
			case ID:
				enterOuterAlt(_localctx, 5);
