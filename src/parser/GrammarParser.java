...
public class GrammarParser extends Parser {
	...
	public static final int
		...
		T__38=39, ID=40, INT_LITERAL=41, FLOAT_LITERAL=42, CHAR_LITERAL=43, LINE_COMMENT=44, 
	...
	private static String[] makeSymbolicNames() {
		return new String[] {
			...
			null, null, null, null, null, null, null, null, null, null, null, null, 
			null, null, null, null, null, null, null, null, null, null, null, null, 
			null, null, null, null, "ID", "INT_LITERAL", "FLOAT_LITERAL", "CHAR_LITERAL", 
	...
	public final ProgramContext program() throws RecognitionException {
		...
		try {
			...
			_la = _input.LA(1);
			while (((_la) & ~0x3f) == 0 && ((1L << _la) & 1099511628034L) != 0) {
				{
				{
				setState(20);
	...
	public final FunctionDefinitionContext functionDefinition() throws RecognitionException {
		...
		try {
			...
			_errHandler.sync(this);
			_la = _input.LA(1);
			while (((_la) & ~0x3f) == 0 && ((1L << _la) & 16492709903376L) != 0) {
				{
				{
				setState(67);
	...
	public final StatementContext statement() throws RecognitionException {
		...
		try {
			...
			case 1:
				...
				_errHandler.sync(this);
				_la = _input.LA(1);
				if (((_la) & ~0x3f) == 0 && ((1L << _la) & 16492709019664L) != 0) {
					{
					setState(93);
			...
			case 10:
				...
				setState(217);
				match(T__6);
				 ((StatementContext)_localctx).ast =  new For(((StatementContext)_localctx).v.ast, ((StatementContext)_localctx).e1.ast, new Assignment(((StatementContext)_localctx).e2.ast, ((StatementContext)_localctx).e3.ast), ((StatementContext)_localctx).s); 
				}
				break;
			}
		}
			...
			while ( _alt!=2 && _alt!=org.antlr.v4.runtime.atn.ATN.INVALID_ALT_NUMBER ) {
				if ( _alt==1 ) {
					...
					case 3:
						...
						((ExpressionContext)_localctx).op = _input.LT(1);
						_la = _input.LA(1);
						if ( !(((_la) & ~0x3f) == 0 && ((1L << _la) & 6445596672L) != 0) ) {
							((ExpressionContext)_localctx).op = (Token)_errHandler.recoverInline(this);
						}
						else {
							if ( _input.LA(1)==Token.EOF ) matchedEOF = true;
